...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/gopalverma33', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/gopal-verma-955531339/', label: 'LinkedIn' },
    { icon: Twitter, href: '#', label: 'Twitter' },
    { icon: Instagram, href: 'https://www.instagram.com/gopalverrma/', label: 'Instagram' },
    { 
      icon: () => (
      ...
      href: 'https://leetcode.com/Gopal_verma/', 
      label: 'LeetCode' 
    },
    { icon: Mail, href: 'mailto:gpverma869@gmail.com', label: 'Email' },
  ];
